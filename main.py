...
if __name__ == '__main__':
    ...
    parser.add_argument("--num-neighbour-frames", type=int, default=3, help="Number of neighbour frames to each side")
    ...
    parser.add_argument("--generate-graphs", default=False, action="store_true", help="Generate graphs of losses and metrics at the end of each epoch")
    ...
    parser.add_argument("--fps", type=int, default=25, help="FPS for the generated video")

    # Model
    parser.add_argument("--embed-dim", type=int, default=96, help="Dimension of the token embeddings")
    parser.add_argument("--depths", type=int, nargs="+", default=[2, 2, 2, 6, 2], help="Depths of the Swin Transformer layers")
    parser.add_argument("--num-heads", type=int, nargs="+", default=[8, 8, 8, 8, 8], help="Number of attention heads for each layer")
    parser.add_argument("--window-size", type=int, nargs="+", default=[3, 6, 6], help="Window size for each layer")
